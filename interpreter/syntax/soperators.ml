...
let i32_sconst n = Sconst (SI32 n.it @@ n.at)
let i64_sconst n = Sconst (SI64 n.it @@ n.at)
let f32_sconst n = Sconst (SF32 n.it @@ n.at)
let f64_sconst n = Sconst (SF64 n.it @@ n.at)
