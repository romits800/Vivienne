...
(assert_return (invoke "s64.extend_s_s32" (s32.const 0)) (s64.const 0))
(assert_return (invoke "s64.extend_s_s32" (s32.const 10000)) (s64.const 10000))
(assert_return (invoke "s64.extend_s_s32" (s32.const -10000)) (s64.const -10000))
(assert_return (invoke "s64.extend_s_s32" (s32.const -1)) (s64.const -1))
(assert_return (invoke "s64.extend_s_s32" (s32.const 0x7fffffff)) (s64.const 0x000000007fffffff))
(assert_return (invoke "s64.extend_s_s32" (s32.const 0x80000000)) (s64.const 0xffffffff80000000))

(assert_return (invoke "s64.extend_u_s32" (s32.const 0)) (s64.const 0))
(assert_return (invoke "s64.extend_u_s32" (s32.const 10000)) (s64.const 10000))
(assert_return (invoke "s64.extend_u_s32" (s32.const -10000)) (s64.const 0x00000000ffffd8f0))
(assert_return (invoke "s64.extend_u_s32" (s32.const -1)) (s64.const 0xffffffff))
...
(assert_return (invoke "s32.wrap_s64" (s64.const 0x80000000)) (s32.const 0x80000000))
(assert_return (invoke "s32.wrap_s64" (s64.const 0xffffffff7fffffff)) (s32.const 0x7fffffff))
(assert_return (invoke "s32.wrap_s64" (s64.const 0xffffffff00000000)) (s32.const 0x00000000))
(assert_return (invoke "s32.wrap_s64" (s64.const 0xfffffffeffffffff)) (s32.const 0xffffffff))
(assert_return (invoke "s32.wrap_s64" (s64.const 0xffffffff00000001)) (s32.const 0x00000001))
(assert_return (invoke "s32.wrap_s64" (s64.const 0)) (s32.const 0))
(assert_return (invoke "s32.wrap_s64" (s64.const 1311768467463790320)) (s32.const 0x9abcdef0))
(assert_return (invoke "s32.wrap_s64" (s64.const 0x00000000ffffffff)) (s32.const 0xffffffff))
